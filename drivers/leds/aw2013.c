 ...
 * leds-aw2013
 */
#define pr_fmt(fmt) "[AW2013]%s: " fmt, __func__
...
enum aw2013_mode {
	...
	AW2013_MODE_BLINK_3,			 /* Breath between BLINK_1 and BLINK_2.For missed message .
									T1=T3=1.04s,  T2=T4=0.52s,  */
	AW2013_MODE_BLINK_4,			 /* T0=T2=0s,	   T1=0.5s, T3=0.5s.  */
	AW2013_MODE_BLINK_5,			 /* for notification 6s led baseline requirement in 201505 ,
									T1=T2=T3=1.04s T4=2.08 period=5.2s  */
	AW2013_MODE_BLINK_6,			 /*Blue led breath for p852a01*/
	AW2013_MODE_BLINK_7,
	AW2013_MODE_BLINK_8,			 /* T1=T2=T3=0.26s,	  T4=8.32s.  */
...
static int aw2013_set_registers(struct aw2013_data *drvdata)
{
	...
	case AW2013_MODE_ALL_ON:
		pr_info("entry  AW2013_MODE_ALL_ON\n");
	...
	case AW2013_MODE_BLINK_1:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_1\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x32);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x34);
	...
	case AW2013_MODE_BLINK_2:	/*Breath fast. For power on.*/
		pr_info("entry  AW2013_MODE_BLINK_2\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 1.04s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x33);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 4.16s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x35);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0xff);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_3:  /*Breath between BLINK_1 and BLINK_2. For missed message .*/
		pr_info("entry  AW2013_MODE_BLINK_3\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x32);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x32);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0xff);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_4:
		 pr_info("entry  AW2013_MODE_BLINK_4\n");
		 aw2013_write_init(drvdata);
		 aw2013_register_write(drvdata, buf, LCFG0_EN, 0x11);/* enable the register of LEDO*/
		 aw2013_register_write(drvdata, buf, AW_PWM0, 0xff);/*bringhtness=256*/
		 break;
	case AW2013_MODE_BLINK_5:
		pr_info("entry  AW2013_MODE_BLINK_5\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 1.04s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x33);
	...
	case AW2013_MODE_BLINK_6:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_6\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG2_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED2T0, 0x32);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED2T1, 0x34);
	...
	case AW2013_MODE_BLINK_7:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_7\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG2_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED2T0, 0x02);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED2T1, 0x01);
		aw2013_register_write(drvdata, buf, LED2T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM2, 0x80);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_8:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_8\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 001 = 0.26s	 T2:001 brightness keeper 0.26s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x11);
		/*LED0 T3:falling 001 = 0.26s	 T4:001 dark keeper 8.32s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x16);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0xff);/*bringhtness=256*/
		break;
	case AW2013_MODE_BREATH_RED:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BREATH_RED\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper1.04s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x33);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x34);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
	...
	case AW2013_MODE_BREATH_BLUE:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BREATH_BLUE\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG2_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 1.04s	 T2:011 brightness keeper 1.04s*/
		aw2013_register_write(drvdata, buf, LED2T0, 0x33);
		/*LED0 T3:falling 011 = 1.04s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED2T1, 0x34);
		aw2013_register_write(drvdata, buf, LED2T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM2, 0x80);/*bringhtness=256*/
	...
	case AW2013_MODE_BLINK_RED:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_RED\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 0.13s	 T2:011 brightness keeper1.04s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x03);
		/*LED0 T3:falling 011 = 0.13s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x04);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0x80);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_GREEN:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_GREEN\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG1_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 0.13s	 T2:011 brightness keeper 1.04s*/
		aw2013_register_write(drvdata, buf, LED1T0, 0x03);
		/*LED0 T3:falling 011 = 0.13s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED1T1, 0x04);
		aw2013_register_write(drvdata, buf, LED1T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM1, 0x80);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_BLUE:	/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_BLUE\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG2_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 0.13s	 T2:011 brightness keeper 1.04s*/
		aw2013_register_write(drvdata, buf, LED2T0, 0x03);
		/*LED0 T3:falling 011 = 0.13s	 T4:001 dark keeper 2.08s*/
		aw2013_register_write(drvdata, buf, LED2T1, 0x04);
		aw2013_register_write(drvdata, buf, LED2T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM2, 0x80);/*bringhtness=256*/
		break;
	case AW2013_MODE_RED_ON:
		pr_info("entry  AW2013_MODE_RED_ON\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x61);/* enable the register of LEDO*/
	...
	case AW2013_MODE_GREEN_ON:
		pr_info("entry  AW2013_MODE_GREEN_ON\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG1_EN, 0x61); /* enable the register of LEDO */
		aw2013_register_write(drvdata, buf, AW_PWM0, 0x00);
		aw2013_register_write(drvdata, buf, AW_PWM1, 0x80); /* bringhtness=128 */
		aw2013_register_write(drvdata, buf, AW_PWM2, 0x00);
		break;
	case AW2013_MODE_BLUE_ON:
		pr_info("entry  AW2013_MODE_BLUE_ON\n");
		aw2013_write_init(drvdata);
	...
	case AW2013_MODE_MID_ON:
		pr_info("entry  AW2013_MODE_MID_ON\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x61);/* enable the register of LEDO*/
		aw2013_register_write(drvdata, buf, LCFG1_EN, 0x61);/* enable the register of LED1*/
	...
	case AW2013_MODE_SIDE_ON:
		pr_info("entry  AW2013_MODE_SIDE_ON\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x61);/* enable the register of LEDO*/
		aw2013_register_write(drvdata, buf, LCFG1_EN, 0x61);/* enable the register of LED1*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0x00);/*bringhtness=128*/
	...
	case AW2013_MODE_ALL_OFF:
		pr_info("entry  AW2013_MODE_ALL_OFF\n");
		aw2013_register_write(drvdata, buf, RSTR, 0x55);
	...
	case AW2013_MODE_BLINK_RED_3p5:/*Breath slow. For charger*/
		pr_info("entry  AW2013_MODE_BLINK_RED_3p5\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG0_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 0.13s	 T2:011 brightness keeper0.52s*/
		aw2013_register_write(drvdata, buf, LED0T0, 0x02);
		/*LED0 T3:falling 011 = 0.13s	 T4:001 dark keeper 4.16s*/
		aw2013_register_write(drvdata, buf, LED0T1, 0x05);
		aw2013_register_write(drvdata, buf, LED0T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM0, 0x80);/*bringhtness=256*/
		break;
	case AW2013_MODE_BLINK_GREEN_3p5:	/*Breath slow. For charger*/
		pr_info("entry  vAW2013_MODE_BLINK_GREEN_3p5\n");
		aw2013_write_init(drvdata);
		aw2013_register_write(drvdata, buf, LCFG1_EN, 0x71);/* enable the register of LEDO*/
		/*LED0 T1:rising 011 = 0.13s	 T2:011 brightness keeper 0.52s*/
		aw2013_register_write(drvdata, buf, LED1T0, 0x02);
		/*LED0 T3:falling 011 = 0.13s	 T4:001 dark keeper 4.16s*/
		aw2013_register_write(drvdata, buf, LED1T1, 0x05);
		aw2013_register_write(drvdata, buf, LED1T2, 0x40);/*blink always*/
		aw2013_register_write(drvdata, buf, AW_PWM1, 0x80);/*bringhtness=256*/
		break;
	default:
				   ...
				   const char *buf, size_t size)
{
	...
	pr_debug("LED0T0 0x37 value = %x ,pause_rising = %d\n", val, drvdata->pause_rising);
	a = aw2013_set_pause_value(drvdata->pause_rising);
	val = (a<<4) | (val & 0x7);
	aw2013_register_write(drvdata, buf2, LED0T0, val);
	err = aw2013_i2c_read(drvdata->client, LED0T0, &val);
	pr_info("LED0T0 0x37 value = %x ,pause_rising T1= %d.%02d s,\n", val, 13*(1<<a)/100, 13*(1<<a)%100);
	return size;
}
				   ...
				   const char *buf, size_t size)
{
	...
	pr_debug("LED0T1 0x38 value = %x ,pause_falling = %d\n", val, drvdata->pause_falling);
	a = aw2013_set_pause_value(drvdata->pause_falling);
	val = (a<<4) | (val & 0x7);
	aw2013_register_write(drvdata, buf2, LED0T1, val);
	err = aw2013_i2c_read(drvdata->client, LED0T1, &val);
	pr_info("LED0T0 0x38 value = %x ,pause_falling T1= %d.%02d s,\n", val, 13*(1<<a)/100, 13*(1<<a)%100);
	return size;
}
				   ...
				   const char *buf, size_t size)
{
	...
	aw2013_register_write(drvdata, buf2, LED0T0, val);
	err = aw2013_i2c_read(drvdata->client, LED0T0, &val);
	pr_info("LED0T0 0x37 value = %x ,pause_hi T2= %d.%02d s,\n", val, 13*(1<<a)/100, 13*(1<<a)%100);
	return size;
}
				   ...
				   struct device_attribute *attr, char *buf)
{
	...
	pr_debug("entry drvdata->pause_lo =%d\n", drvdata->pause_lo);
				   ...
				   const char *buf, size_t size)
{
	...
	pr_debug("LED0T0 0x38 value = %x ,pause_lo = %d\n", val, drvdata->pause_lo);

	a = aw2013_set_pause_value(drvdata->pause_lo);
	val = (val & 0xf0) | a;
	aw2013_register_write(drvdata, buf2, LED0T1, val);
	err = aw2013_i2c_read(drvdata->client, LED0T1, &val);
	pr_info("LED0T1 0x38 value = %x ,pause_lo T4= %d.%02d s,\n", val, 13*(1<<a)/100, 13*(1<<a)%100);
	return size;
}
				   ...
				   const char *buf, size_t size)
{
	...
	if (enable == 0) {
		pr_info("printkatomic_cmpxchg is disabled\n");
		return AW2013_ERROR;
	}
		...
		enum led_brightness value)
{
	...
	if (value) {
		aw2013_register_write(drvdata, buf, AW_GCR, 0x01);/*GCR*/
		aw2013_register_write(drvdata, buf, LCTR, 0x07);/*LED Control register*/
		pr_debug("%s: drvdata->led0_led_enable %d\n", __func__, drvdata->led0_led_enable);
		if (drvdata->led0_led_enable) {
		...
		pr_debug("%s: drvdata->led1_led_enable %d\n", __func__, drvdata->led1_led_enable);
		if (drvdata->led1_led_enable) {
			aw2013_register_write(drvdata, buf, LCFG1_EN, 0x01);/* enable the register of LED1*/
			aw2013_register_write(drvdata, buf, AW_PWM1, value);
		}
		pr_debug("%s: drvdata->led2_led_enable %d\n", __func__, drvdata->led2_led_enable);
		if (drvdata->led2_led_enable) {
			aw2013_register_write(drvdata, buf, LCFG2_EN, 0x01);/* enable the register of LED2*/
			...
			struct aw2013_data *drvdata)
{
	...
	pr_info("aw2013 temp_val is %d\n", temp_val);
	
	drvdata->led0_led_enable = of_property_read_bool(np, "aw2013,led0");
	drvdata->led1_led_enable = of_property_read_bool(np, "aw2013,led1");
	drvdata->led2_led_enable = of_property_read_bool(np, "aw2013,led2");
	...
	if (drvdata == NULL) {
		...
		dev_err(&client->dev,
				"failed to allocate memory for module data: "
					"%d\n", err);
		pr_info("aw2013 error2: drvdata is null\n");
		goto exit_check_functionality_failed;
	}
...
{
	return i2c_del_driver(&aw2013_driver);
}
